...
class Song < ActiveRecord::Base
  ...
  validates_attachment_content_type :mp3, :content_type => ['x-mp3','audio/mp3'], message: "Wrong content type, only MP3 files are allowed", notice: "Wrong content type, only MP3 files are allowed"
